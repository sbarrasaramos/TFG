...
\begin{document}
	...
	%%%%
	\input{capitulos/1_introduction}	
	\input{capitulos/2_objectives}
	\input{capitulos/3_active_suspensions}
	\input{capitulos/4_fluid_mechanics}
	\input{capitulos/5_brownian_motion}
	\input{capitulos/6_state_of_the_art}
	\input{capitulos/7_materials_and_methods}
	\input{capitulos/8_results_and_analysis}
	\input{capitulos/9_conclusions}
